...
@Plugin({
  ...
  plugin: 'cordova-plugin-jasonkit-imagepicker',
  pluginRef: 'window.imagePicker',
  repo: 'https://github.com/jasonkit/ImagePicker',
  install: 'ionic cordova plugin add cordova-plugin-jasonkit-imagepicker --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="your usage message"',
