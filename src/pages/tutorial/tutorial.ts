    ...
    translate.get(["TUTORIAL_SLIDE1_TITLE",
      ...
      (values) => {
        ...
        this.slides = [
          {
            title: "What is chuzz?",
            description: "Description of chuzz",
            image: 'assets/img/1.jpg',
          },
          {
            title: "How to select categories?",
            description: "How to select categories?",
            image: 'assets/img/2.jpg',
          },
          {
            title: "How to select country?",
            description: "How to select country?",
